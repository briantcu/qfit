json.extract! @daily_routine, :id, :user_id, :group_id, :day_performed, :weight, :power_index, :count_ex_provided, :count_ex_completed, :program_day_id, :wt_day_id, :sp_day_id, :pl_day_id, :wu_day_id, :modified, :pl_modified, :wt_modified, :wu_modified, :sp_modified, :changes_saved, :closed, :group_routine_id

json.performed_warm_ups @daily_routine.performed_warm_ups, :id, :status, :completed, :warmup
json.performed_exercises @daily_routine.performed_exercises, :id, :status, :rest_period, :exercise_type_id, :weight_sets, :exercise
