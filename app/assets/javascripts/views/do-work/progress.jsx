                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12 chart-header">
                            <div className="row">
                                <div className="col-xs-12 col-sm-5 small-title">
                                    {this.state.title}
                                </div>
                                <div className="col-xs-12 col-sm-7 text-right">
                                    <span onClick={() => this.periodChanged(this.periods.one_month) }
                                          className={(this.state.period ==  this.periods.one_month) ? 'selected-period' : 'period'}>30 Days</span>
                                    <span onClick={() => this.periodChanged(this.periods.two_month) }
                                          className={(this.state.period ==  this.periods.two_month) ? 'selected-period' : 'period'}>60 Days</span>
                                    <Choose>
                                        <When condition={gon.has_premium_access} >
                                            <span onClick={() => this.periodChanged(this.periods.three_months) }
                                                  className={(this.state.period == this.periods.three_months) ? 'selected-period' : 'period'}>90 Days</span>
                                            <span onClick={() => this.periodChanged(this.periods.one_year) }
                                                  className={(this.state.period ==  this.periods.one_year) ? 'selected-period' : 'period'}>One Year</span>
