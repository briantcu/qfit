...
class Schedule extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            weights: gon.changing === 'schedule' ? props.user_schedule.weights : props.quads.strength,
            plyos: gon.changing === 'schedule' ? props.user_schedule.plyos : props.quads.plyos,
            sprinting: gon.changing === 'schedule' ? props.user_schedule.sprinting : props.quads.sprinting
        };
        ...
        return <div className="schedule metal-bg no-margin">
            <div className="row no-margin">
                <div className="container">
                    ...
                    <If condition={this.state.weights}>
                    ...
                    <If condition={this.state.sprinting}>
                        <div className="row details">
                            <div className="col-xs-10 col-xs-offset-1 text-center">
