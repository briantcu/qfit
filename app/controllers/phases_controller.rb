class PhasesController < ApplicationController
  ...
  private
    ...
    def phase_params
      params.require(:phase).permit(:male_power_sets, :male_power_reps, :male_other_sets, :male_other_reps, :fem_power_sets, :fem_power_reps, :fem_other_sets, :fem_other_reps)
    end
end
