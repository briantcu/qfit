...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { exercise_id: @tip.exercise_id, exercise_type: @tip.exercise_type, tip: @tip.tip }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { exercise_id: @tip.exercise_id, exercise_type: @tip.exercise_type, tip: @tip.tip }
    assert_redirected_to tip_path(assigns(:tip))
  end
